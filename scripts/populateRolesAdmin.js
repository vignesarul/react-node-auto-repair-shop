...
const roles = [{
  'name' : 'manager',
  'permissions' : [
    '_.users.read', '_.users.write', '_.users.update', '_.users.delete', 'repairs.read', 'repairs.write',
    'repairs.update', 'repairs.delete', 'users.read', 'users.write', 'users.update', 'users.delete', 'roles.write'
  ],
  'level' : 1
  }, {
    'name' : 'user',
